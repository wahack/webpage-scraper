...
module.exports = [wrap(function ($) {
  ...
  return $('meta[name="description"]').attr('content') || $('meta[name="Description"]').attr('content')
}), wrap(function ($) {
  return $('meta[itemprop="description"]').attr('content')
}), wrap(function ($) {
  return $('.post-content p').first().text() || null
}), wrap(function ($) {
  return $('.entry-content p').first().text() || null
}), wrap(function ($) {
